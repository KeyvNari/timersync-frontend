...
export class SimpleWebSocketService {
  ...
  selectTimer(timerId: number, timerData?: Partial<TimerData>): void {
    this.send({ type: 'timer_selected', timer_id: timerId, timer_data: timerData || {} });
  }
...
export function createSimpleWebSocketService(options: WebSocketServiceOptions): SimpleWebSocketService {
